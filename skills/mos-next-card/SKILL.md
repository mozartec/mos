...
building the confirmed pick is mos-ship-card's job.
...
Hand the confirmed id to the mos-ship-card skill — shipping is its job, not this skill's.
If mos-ship-card isn't installed, say so and stop at the recommendation.
